...
import { catalogItemIdValidator, createCatalogItemValidator, updateCatalogItemValidator } from '../validators';
...
router.get('/type/:id', tokenValidation, validateUserRole(USER), ...catalogItemIdValidator, validateFields, getCatalogItemsByType);

// Get Catalog Items for administration
// Code: ESAVI-CATITEM-002B
router.get('/admin/type/:id', tokenValidation, validateUserRole(ADMIN), getAllCatalogItemsByType);
