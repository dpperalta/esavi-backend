...
// There is no code in either body: it is minted from the name with toCodeFromName, so one travelling
// in the body would be accepted and discarded. A name that mints no usable code — only separators,
// or long enough to overflow varchar(100) — is a 400 of the service and not of these validators,
// which cannot see the rule
