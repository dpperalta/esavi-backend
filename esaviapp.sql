...
CREATE TABLE IF NOT EXISTS "classification" (
  ...
  "isSeriousEvent" boolean NOT NULL DEFAULT false,
  "causedDeath" boolean NOT NULL DEFAULT false,
  "causedDisability" boolean NOT NULL DEFAULT false,
  "causedCongenitalAnomaly" boolean NOT NULL DEFAULT false,
  "causedFetalDeath" boolean NOT NULL DEFAULT false,
  "causedLifeThreatening" boolean NOT NULL DEFAULT false,
  "causedHospitalization" boolean NOT NULL DEFAULT false,
  "causedAbortion" boolean NOT NULL DEFAULT false,
  "causedOtherCondition" boolean NOT NULL DEFAULT false,
