...
CREATE TABLE IF NOT EXISTS "whodrugProduct" (
  ...
  "optionNameSearch" text NOT NULL,
  "metadata" jsonb NOT NULL DEFAULT '{}'::jsonb,
  "isActive" boolean NOT NULL DEFAULT true,
  "createdAt" timestamptz NOT NULL DEFAULT current_timestamp,
  "updatedAt" timestamptz,
...
CREATE TABLE IF NOT EXISTS "notifier" (
  ...
  CONSTRAINT "FK_notifier_geoLocation" FOREIGN KEY ("geoLocationId") REFERENCES "geoLocation" ("geoLocationId") ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS "classification" (
  ...
  "causedCongenitalAnomaly" boolean,
  "causedFetalDeath" boolean,
  "causedLifeThreatening" boolean,
  "causedHospitalization" boolean,
  "causedAbortion" boolean,
  "causedOtherCondition" boolean,
...
CREATE TABLE IF NOT EXISTS "notification" (
  ...
  "outcomeItemId" uuid,
  "requestInvestigation" boolean default false,
  "deathDate" date,
  "autopsyRequested" boolean,
  "verbalAutopsyPerformed" boolean,
  "notes" text,
  "isActive" boolean NOT NULL DEFAULT true,
  "createdAt" timestamptz NOT NULL DEFAULT current_timestamp,
  "updatedAt" timestamptz,
...
CREATE TABLE IF NOT EXISTS "nonSevereNotification" (
  ...
  "verifiedPhysicalDocument" boolean,
  "verifiedElectronicRecord" boolean,
  "verifiedVerbalReport" boolean,
  "verifiedClinicalRecord" boolean,
  "verifiedUnknown" boolean,
  "verifiedOtherSource" boolean,
...
CREATE TABLE IF NOT EXISTS "investigationSource" (
  ...
  "history" boolean,
  "interviewVaccinatedPerson" boolean,
  "interviewHealthWorker" boolean,
  "vaccinationRecord" boolean,
  "autopsyRecord" boolean,
  "verbalAutopsyRecord" boolean,
...
CREATE TABLE IF NOT EXISTS "investigationClinicalEvaluation" (
  ...
  "sourceVerbalAutopsy" boolean,
  "sourceOther" boolean,
  "otherDescription" text,
  "suspectedChildAbuse" boolean,
  "childAbuseExplanation" text,
  "suspectedDomesticViolence" boolean,
...
CREATE TABLE IF NOT EXISTS "investigationVaccinationContext" (
  ...
  -- If answer is "No", then the following field is required
...
CREATE TABLE IF NOT EXISTS "investigationColdChain" (
  "investigationId" uuid PRIMARY KEY,
  "storageTemperatureMonitored" boolean,
  "storageRangeDeviation" boolean,
...
CREATE TABLE IF NOT EXISTS "investigationAdministrationError" (
  ...
  -- If answer is "No", then the following fields are required
  "usedGlassSyringes" boolean,
  "usedDisposableSyringes" boolean,
...
CREATE TABLE IF NOT EXISTS "investigationCommunity" (
  ...
  -- If answer is "Yes", then the following fields are required
...
CREATE TABLE IF NOT EXISTS "finalClassification" (
  ...
  "aIsRelatedToVaccineProduct" boolean,
  "aIsRelatedToQualityDeviation" boolean,
  "aIsRelatedToProgrammaticError" boolean,
  "aIsRelatedToStress" boolean,
  "bIsConsistentTemporalRelation" boolean,
  "bHasDeterminantFactor" boolean,
  "cHasCoincidentCause" boolean,
  "dIsUnclassifiable" boolean,
  "notes" text,
  "isActive" boolean NOT NULL DEFAULT true,
  "createdAt" timestamptz NOT NULL DEFAULT current_timestamp,
  "updatedAt" timestamptz,
